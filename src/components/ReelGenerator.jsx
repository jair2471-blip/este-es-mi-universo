              ...
              <div className="mx-auto" style={{ maxWidth: '350px' }}>
                <div className="bg-black rounded-3xl p-3 shadow-2xl border-2"
                  ...
                  >
                    ...
                    >
                      <h1 
                        className="font-black mb-4 leading-tight tracking-wider break-words px-4"
                        style={{ 
                      ...
                      <p 
                        className="font-bold opacity-90 tracking-wide break-words px-4"
                        style={{ 
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-black/50 text-white px-4 py-3 rounded-xl outline-none border-2 font-bold tracking-wider"
                    style={{ 
                      borderColor: currentScheme.accent + '60',
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-black/50 text-white px-4 py-3 rounded-xl outline-none border-2"
                    style={{ 
